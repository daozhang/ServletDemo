...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/demo/resources/scripts/jquery-1.3.2.min.js"></script>
<script type="text/javascript"
	...
	<div id="body-wrapper">
		<div id="sidebar">
			<div id="sidebar-wrapper">
				...
				<a href="#"><img id="logo"
					src="<%=request.getContextPath()%>/demo/resources/images/logo.png"
		...
		<div id="main-content">
			...
			<ul class="shortcut-buttons-set">
				<li><a class="shortcut-button" href="#"><span> <img
							src="<%=request.getContextPath()%>/demo/resources/images/icons/pencil_48.png"
							alt="icon" /><br /> Write an Article
					</span></a></li>
				<li><a class="shortcut-button" href="#"><span> <img
							src="<%=request.getContextPath()%>/demo/resources/images/icons/paper_content_pencil_48.png"
							alt="icon" /><br /> Create a New Page
					</span></a></li>
				<li><a class="shortcut-button" href="#"><span> <img
							src="<%=request.getContextPath()%>/demo/resources/images/icons/image_add_48.png"
							alt="icon" /><br /> Upload an Image
					</span></a></li>
				<li><a class="shortcut-button" href="#"><span> <img
							src="<%=request.getContextPath()%>/demo/resources/images/icons/clock_48.png"
							alt="icon" /><br /> Add an Event
					</span></a></li>
				<li><a class="shortcut-button" href="#messages" rel="modal"><span>
							<img
							src="<%=request.getContextPath()%>/demo/resources/images/icons/comment_48.png"
							alt="icon" /><br /> Open Modal
					</span></a></li>
			</ul>
					...
					<div class="tab-content default-tab" id="tab1">
						...
						<div class="notification attention png_bg">
							<a href="#" class="close"><img
								src="<%=request.getContextPath()%>/demo/resources/images/icons/cross_grey_small.png"
								...
								<tr>
									...
									<td>
										<!-- Icons --> <a href="#" title="Edit"><img
											src="<%=request.getContextPath()%>/demo/resources/images/icons/pencil.png"
											alt="Edit" /></a> <a href="#" title="Delete"><img
											src="<%=request.getContextPath()%>/demo/resources/images/icons/cross.png"
											alt="Delete" /></a> <a href="#" title="Edit Meta"><img
											src="<%=request.getContextPath()%>/demo/resources/images/icons/hammer_screwdriver.png"
											alt="Edit Meta" /></a>
									</td>
								</tr>
								<tr>
